...
class ConnpassDataSource {
  ...
  Future<EventList> fetchEventList() {
    ...
    return client.get(url).then((response) {
      ...
      return EventList(events: resultConnpassEntity.events.map((eventEntity) {
        return Event(
          ...
          latitude: eventEntity.latitude != null ?  double.parse(eventEntity.latitude) : null,
          longitude: eventEntity.longitude != null ? double.parse(eventEntity.longitude) : null,
        );
      }).toList());
    });
  }
